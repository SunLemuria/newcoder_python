# https://www.nowcoder.com/profile/1309942/codeBookDetail?submissionId=12608688
...
def check_mask(ms):
    ...
    if ms[0] == '255':
        if ms[1] == '255':
            if ms[2] == '255':
                return ms[3] in lll
            return ms[2] in lll and ms[3] == '0'
        return ms[1] in lll and ms[2] == ms[3] == '0'
    return ms[0] in lll and ms[1] == ms[2] == ms[3] == '0'
